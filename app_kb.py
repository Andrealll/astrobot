...
# prova: usa la tua funzione reale se disponibile
try:
    from metodi import interpreta_groq  # sostituisci con la tua
except Exception:
...
@kb_router.post("/interpreta-natal")
...
@kb_router.post("/interpreta-transit")
